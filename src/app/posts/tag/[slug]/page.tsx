...
import { PROJECT_TAG_SLUG_QUERYResult, Slug, TAGS_SLUG_QUERYResult } from "@/types/sanity";
import { PROJECT_TAG_SLUG_QUERY, TAGS_SLUG_QUERY } from "@/lib/sanity-utils/sanityQueries";
